...
<body>
    <div class="header" style="background-color: #F9F9E0;">
        <h3 class="text-secondary font-weight-bold float-left logo">Dashboard</h3>
    </div>
        ...
        <nav>
            <ul>
                ...
                <a href="dashboard" style="text-decoration: none;">
                    <li class="aktif" style="border-left: 5px solid #F9F9E0;">
                        <div>
                ...
                <div class="container" id="container" style="border: none;">
                    <div class="row tampilCardview" id="row">
                        <div class="col-md-4 jarak">
                            <div class="card card-stats card-warning" style="background: #AA96DA;">
                                <div class="card-body ">
                                    <div class="row">
                                        <div class="col-5">
                        ...
                        <div class="col-md-4 jarak">
                            <a href="tambahPengeluaran" style="text-decoration: none;">
                                <div class="card card-stats card-warning" style="background: #FF90BC;">
                                    <div class="card-body ">
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
                                ...
                                <div class="overlay" style="background: #FF76CE;">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
                        ...
                        <div class="col-md-4 jarak">
                            <a href="tambahPemasukkan" style="text-decoration: none;">
                                <div class="card card-stats card-warning" style="background: #8ACDD7;">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
                                ...
                                <div class="overlay" style="background: #4793AF;">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
